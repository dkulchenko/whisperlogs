defmodule WhisperLogsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(WhisperLogsWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(WhisperLogsWeb.Gettext, "errors", msg, opts)
    # end
