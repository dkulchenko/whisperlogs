defmodule WhisperLogs.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, WhisperLogs.Repo)
  ...
  """
  def valid_password?(%WhisperLogs.Accounts.User{hashed_password: hashed_password}, password)
